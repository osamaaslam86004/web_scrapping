...
def run_ocr(image):
    ...
    """
    try:
        config = "--psm 3 --oem 1 " "preserve_interword_spaces=1"
    ...
    for line_key, line in line_dict.items():
        if line["has_arrow"] or line["has_parentheses"]:
            ...
            extracted_text.append(full_line)  # change here
    ...
    return {
        ...
        "extracted_text": extracted_text,  # change here
    }
